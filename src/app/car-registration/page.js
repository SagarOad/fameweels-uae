...
export default function CarRegistration() {
  ...
  return (
    <>
      <SeoMeta
        title=" Vehicle Registration | Famewheels"
        desc="Easily navigate vehicle registration with Famewheels' comprehensive Vehicle Registration Calculator. Calculate costs, understand requirements, and streamline the registration process for your new vehicle with expert guidance from Famewheels"
